...
namespace WpfChatServer.Models
{
	public class ChatHub : Hub<IClient>
	{
		...
		public override Task OnDisconnected(bool stopCalled)
		{
			...
			if (userName != null)
			{
				...
				App.ChatStates.Add($"<> {userName} disconnected");
			}
		...
		public override Task OnReconnected()
		{
			...
			if (userName != null)
			{
				...
				App.ChatStates.Add($"<> {userName} reconnected");
			}
		...
		public List<User> Login(string name, byte[] photo)
		{
			if (!ChatClients.ContainsKey(name))
			{
				...
				App.ChatStates.Add($"++ {name} logged in");
		...
		public void Logout()
		{
			...
			if (!string.IsNullOrEmpty(name))
			{
				...
				App.ChatStates.Add($"-- {name} logged out");
			}
		}
